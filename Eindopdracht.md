<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="container">
                    ...
                    <div class="column">
                        ...
                        <table class="dealer-information">
                            <tbody>
                                ...
                                <tr>
                                    <td>Website</td><td><a href="https://www.angelslo-autos.nl">https://www.angelslo-autos.nl</a></td>
                                </tr>
                                <tr>
        ...
        &nbsp;
            ...
            <article id="https://www.boels-supercars.nl" class="page">
                <header class="dealer-header text-center">
                    <h1 class="align-center">Garage:
                    Boels Supercars</h1>
        ...
        &nbsp;
            ...
            <article id="https://www.dorenboscars.nl" class="page">
                <header class="dealer-header text-center">
                    <h1 class="align-center">Garage:
                    Dorenbos Volvo's</h1>
                    ...
                    <div class="column">
                        ...
                        <table class="dealer-information">
                            <tbody>
                                ...
                                <tr>
                                    <td>Routebeschrijving</td><td><a href="https://goo.gl/maps/Av55mPp56jrd">https://goo.gl/maps/Av55mPp56jrd</a></td>
                                </tr>
                                <tr>
                                    <td>Services</td><td>
            Huren
                ...
                <footer class="dealer-footer">
                    <div class="row">
                        <address class="dealer-address column">
                            <b>
            Address gegevens:
        </b><span title="Naam van het bedrijf">MSK auto's</span><span title="Straatnaam en huisnummer.">marktlaan33</span><span title="Postcode en plaats.">0522 SKMussel</span><span title="Provincie">Groningen</span>
                        </address>
                        <div class="certification-icons column"></div>
                    </div>
                </footer>
                    ...
                    <div class="column">
                        ...
                        <table class="dealer-information">
                            <tbody>
                                ...
                                <tr>
                                    <td>Routebeschrijving</td><td><a href="https://goo.gl/maps/dronrEBVYC52">https://goo.gl/maps/dronrEBVYC52</a></td>
                                </tr>
                                <tr>
                                    <td>Services</td><td>
            Lenen
                ...
                <footer class="dealer-footer">
                    <div class="row">
                        <address class="dealer-address column">
                            <b>
            Address gegevens:
        </b><span title="Naam van het bedrijf">Strikwerda</span><span title="Straatnaam en huisnummer.">De Alde Mar12</span><span title="Postcode en plaats.">9035 VPDronrijp</span><span title="Provincie">Friesland</span>
                        </address>
                        <div class="certification-icons column"></div>
                    </div>
                </footer>
        ...
        &nbsp;
                        ...
                        <section>
                            ...
                            <div class="row">
                                <div class="column-25">
                                    <table class="car-information">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Bouwjaar</td><td>
                                                    <time datetime="Mercedes">Mercedes</time>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Brandstof</td><td>Brandstof</td>
                                            ...
                                            <tr>
                                                <td>APK t\m</td><td>
                                                    <time datetime="18-05-2018">18-05-2018</time>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Kenteken</td><td>67-ES-44</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                <div class="column-75">
                                    <div id="car-picture-cards">
                                        <figure class="employee-figures">
                                            <img alt="Imgag Mercedes Hatchack" src="mercedes_A1.jpg">
                                            <figcaption>mercedes_A1</figcaption>
                                        </figure>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="dealer-content-employee">
                    ...
                    <div id="employee-cards">
                        <figure class="employee-figures">
                            <img alt="Picture of Jaap Oomen" src="JaapO.jpg">
                            <figcaption>
                                <span title="Employee name">Jaap Oomen</span><span title="Employee Job Title">eigenaar</span>
                            </figcaption>
                        </figure>
                        <figure class="employee-figures">
                            <img alt="Picture of Michiel Oomen" src="miom.jpg">
                            <figcaption>
                                <span title="Employee name">Michiel Oomen</span><span title="Employee Job Title">monteur</span>
                            </figcaption>
                        </figure>
                    </div>
                </section>
                <footer class="dealer-footer">
                    <div class="row">
                        <address class="dealer-address column">
                            <b>
            Address gegevens:
        </b><span title="Naam van het bedrijf">Vakgarage Autooomen</span><span title="Straatnaam en huisnummer.">Ambachtsweg1</span><span title="Postcode en plaats.">4854 MKBavel</span><span title="Provincie">Noord-Brabant</span>
                        </address>
                        <div class="certification-icons column"></div>
                    </div>
                </footer>
            ...
            <article id="https://vakgarage-vdheuvel.nl" class="page">
                <header class="dealer-header text-center">
                    <h1 class="align-center">Garage:
                    Vakgarage Van den Heuvel</h1>
                    <h5 class="align-center">We staan voor u klaar en staan garant voor hoge kwaliteit</h5>
                </header>
                <div class="row">
                    <div class="column">
                        <h4 class="align-center">Gegevens van garage</h4>
                        <table class="dealer-information">
                            <tbody>
                                <tr>
                                    <td>Telefoonnummer</td><td>+31 0793-313926&nbsp;
            </td>
                                </tr>
                                <tr>
                                    <td>Email</td><td>vdheuvel@vakgarage.nl&nbsp;
            </td>
                                </tr>
                                <tr>
                                    <td>Website</td><td><a href="https://vakgarage-vdheuvel.nl">https://vakgarage-vdheuvel.nl</a></td>
                                </tr>
                                <tr>
                                    <td>Routebeschrijving</td><td><a href="https://goo.gl/maps/benthEBVYC53">https://goo.gl/maps/benthEBVYC53</a></td>
                                </tr>
                                <tr>
                                    <td>Services</td><td>
            Lenen
        ...
        &nbsp;
                        ...
                        <section>
                            ...
                            <div class="row">
                                <div class="column-25">
                                    <table class="car-information">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>APK t\m</td><td>
                                                    <time datetime="18-05-2019">18-05-2019</time>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Kenteken</td><td>67-LV-21</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                <div class="column-75">
                                    <div id="car-picture-cards">
                                        <figure class="employee-figures">
                                            <img alt="Imgag Volvo Stationwagen" src="volvo97.jpg">
                                            <figcaption>volvo97</figcaption>
                                        </figure>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="dealer-content-employee">
                    ...
                    <div id="employee-cards">
                        <figure class="employee-figures">
                            <img alt="Picture of Johan Volvo" src="Johan.jpg">
                            <figcaption>
                                <span title="Employee name">Johan Volvo</span><span title="Employee Job Title">eigenaar</span>
                            </figcaption>
                        </figure>
                        <figure class="employee-figures">
                            <img alt="Picture of Dries Wiel" src="miom.jpg">
                            <figcaption>
                                <span title="Employee name">Dries Wiel</span><span title="Employee Job Title">monteur</span>
                            </figcaption>
                        </figure>
                    </div>
                </section>
                <footer class="dealer-footer">
                    <div class="row">
                        <address class="dealer-address column">
                            <b>
            Address gegevens:
        </b><span title="Naam van het bedrijf">Vakgarage Van den Heuvel</span><span title="Straatnaam en huisnummer.">Verbreepark33</span><span title="Postcode en plaats.">2731 BRBenthuizen</span><span title="Provincie">Zuid-Holland</span>
                        </address>
                        <div class="certification-icons column"></div>
                    </div>
                </footer>
            ...
            <footer id="footer">
                ...
                <address class="authors">
                    <a href="https://github.com/DavidDorenbos" rel="author">⌖ David Dorenbos,</a><a href="https://github.com//IvarHuizing" rel="author">⌖ Ivar Huizing,</a><a href="https://github.com/MichielTombergen" rel="author">⌖ Michiel Tombergen,</a><a href="https://github.com/andrew946" rel="author">⌖ Andrej Rodzevic,</a><a href="https://github.com/" rel="author">⌖ Thomas Fluit,</a><a href="https://github.com/jorisrietveld" rel="author">⌖ Joris Rietveld</a>
                </address>
            </footer>
        </main>
    </body>
